...
public class SoundManager : MonoBehaviour
{
    ...
    {
        AudioClip audioClipToPlay = audioClipArray[UnityEngine.Random.Range(0, audioClipArray.Length)];
        PlaySound(audioClipToPlay, position, volume);
    }

    private void PlaySound(AudioClip audioClip, Vector3 position, float volumeMultipier = 1f)
    {
        AudioSource.PlayClipAtPoint(audioClip, position, volumeMultipier * volume);
    }
